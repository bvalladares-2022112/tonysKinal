...
import org.brenervalladares.bean.Presupuesto;
...
public class PresupuestoController implements Initializable{
    ...
    public void eliminar() {
        switch (tipoDeOperacion) {
            ...
            default:
         if (tblPresupuestos.getSelectionModel().getSelectedItem() != null) {
            int respuesta = JOptionPane.showConfirmDialog(null, "¿Estas seguro de eliminar el presupuesto?", "Eliminar Presupuesto", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    public void imprimirReporte(){
        ...
        int cod = Integer.valueOf(((Empresa) cmbCodigoEmpresa.getSelectionModel().getSelectedItem()).getCodigoEmpresa());
        URL imagenLogo = this.getClass().getResource("/org/brenervalladares/image/Menusinfondo.png");
        URL imagenFondo = this.getClass().getResource("/org/brenervalladares/image/fondoReporte.png");
        parametros.put("cod", cod);
        parametros.put("imagenLogo", imagenLogo);
        parametros.put("imagenFondo", imagenFondo);
